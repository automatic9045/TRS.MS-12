...
namespace TRS.TMS12.TicketPlugins.TRSTickets.NumberedTickets.Cancel
{
    ...
    public class PluginInfo : BindableBase, ITicketPluginExtension
    {
        ...
        public string TicketName { get; } = "整理券控除";
        ...
        public PluginInfo()
        {
            ...
            TextBoxes.CollectionChanged += (sender, e) =>
            {
                bool canSend =
                    ...
                    TextBoxes[(int)InputControlTextBox.TimeCode] != "" &&
                    TextBoxes[(int)InputControlTextBox.SeatCode] != "" &&
                    TextBoxes[(int)InputControlTextBox.CNumber] != "";

                FunctionKeysIsEnabled[(int)FunctionKeys.Send] = canSend;
            };
        }

        public void AddOption(string value) => throw new NotSupportedException();

        public void SetDiscount(string value) => throw new NotSupportedException();
